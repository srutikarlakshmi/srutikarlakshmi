      ...
      <footer className="footer--container">
        <div className="footer--link--container">
          ...
          <div className="footer--social--icon">
            ...
            <li>
                <a
                  href="https://www.linkedin.com/in/srutika-r-lakshmi-30029062/"
                ...
                <li>
                <a
                  href="https://github.com/srutikarlakshmi"
                  className="navbar--content"
                  target="_blank"
                  rel="noreferrer"
                >                 <svg
              ...
              <li>
                <a
                  href="https://www.instagram.com/_.srutika._17_/"
                  className="navbar--content"
                  target="_blank"
                  rel="noreferrer"
                >
              ...
              <li>
                <a
                  href="https://twitter.com/SrutikaL"
                  className="navbar--content"
                  target="_blank"
                  rel="noreferrer"
                >
        ...
        <div className="footer--content--container">
          <p className="footer--content">Made with 💖 by Srutika R Lakshmi.</p>
          <div className="footer--social--icon">
            <ul>
              <li>
                <Link
        ...
        <p className="footer--source">
          This website is referenced from{" "}
          <a
            href="https://github.com/Ade-mir/react-js-personal-portfolio/tree/main"
            className="source"
            target="_blank"
          >
            {" "}
